...
<html lang="id"> 
<head> 
    <title>Tambah Guru - SIAKAD</title> 
    ...
    <div class="page-header">
        <div class="container">
            <div class="page-title">
                <h1><i class="fas fa-chalkboard-teacher"></i> Tambah Guru</h1>
                <p>Tambahkan data guru baru ke dalam sistem</p>
            </div>
        </div>
    </div>
        ...
        <div class="form-container">
            <form method="post">
                <div class="form-row">
                    ...
                    <div class="form-group"> 
                        <label><i class="fas fa-user"></i> Nama Guru</label> 
                ...
                <div class="form-row">
                    ...
                    <div class="form-group"> 
                        <label><i class="fas fa-graduation-cap"></i> Pendidikan Akhir</label> 
                        <input type="text" name="pend_akhir" class="form-control" placeholder="S1, S2, S3" required> 
                    </div>
                </div>
